...
# 2 "<built-in>" 2
# 1 "MCAL/ADC/mcal_adc.c" 2
# 1 "MCAL/ADC/mcal_adc.h" 1
# 18 "MCAL/ADC/mcal_adc.h"
# 1 "MCAL/ADC/../GPIO/hal_gpio.h" 1
# 16 "MCAL/ADC/../GPIO/hal_gpio.h"
...
# 16 "MCAL/ADC/../GPIO/hal_gpio.h" 2

# 1 "MCAL/ADC/../GPIO/../mcal_std_types.h" 1
# 17 "MCAL/ADC/../GPIO/../mcal_std_types.h"
...
# 17 "MCAL/ADC/../GPIO/../mcal_std_types.h" 2
...
# 17 "MCAL/ADC/../GPIO/hal_gpio.h" 2
# 36 "MCAL/ADC/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 1 "MCAL/ADC/../INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/ADC/../INTERRUPT/internal_interrupt.h"
# 1 "MCAL/ADC/../INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/ADC/../INTERRUPT/manage_interrupt.h"
# 1 "MCAL/ADC/../INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/ADC/../INTERRUPT/interrupt_config.h"
# 1 "MCAL/ADC/../INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/ADC/../INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/ADC/../INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/ADC/../INTERRUPT/manage_interrupt.h" 2




void ISR_ADC(void);
# 19 "MCAL/ADC/../INTERRUPT/internal_interrupt.h" 2
# 19 "MCAL/ADC/mcal_adc.h" 2
# 75 "MCAL/ADC/mcal_adc.h"
typedef enum {
    ADC_CHANNEL_AN0 = 0,
    ADC_CHANNEL_AN1,
    ADC_CHANNEL_AN2,
...
typedef enum {
    ADC_SELECT_ANALOG_ALL_BIT = 0x00,
...
void (* InterruptHandler)(void) = ((void*)0);
void ISR_ADC(void);

static __attribute__((inline)) void adc_input_channel_port_configure(adc_select_channel_t channel);
static __attribute__((inline)) void adc_voltage_reference(const Adc_t *_adc);
static __attribute__((inline)) void adc_result_format(const Adc_t *_adc);
...
Std_ReturnType ADC_Init(const Adc_t *_adc){
    ...
    if(((void*)0) == _adc){
        ...
        (ADCON2bits.ACQT = _adc->TAD_Time);


        (ADCON2bits.ADCS = _adc->FOSC_Clock);
...
{
    Std_ReturnType ret = (Std_ReturnType)1;
    if((((void*)0) == _adc) || (((void*)0) == status_conversion)){
        ret = (Std_ReturnType)1;
    }
    else{
        ret = (Std_ReturnType)1;
        *status_conversion = (uint8)(!(ADCON0bits.GODONE));
    }
    return ret;
}
